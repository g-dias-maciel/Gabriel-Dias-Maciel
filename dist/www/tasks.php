...
echo '<h1 style="text-align: center">Coding Tasks<h1/>
        ...
        Your task is to read all files and parse the data into the same person object.
         The task is to list all data in any output format you choose, which can be a console as well.</h4>
        <h2 style="text-align: center">Algorithm:<h2/>
        <h4>You have a sorted array (ASC) given which can contain up to 1 million integer numbers.
         ...
         Please provide the unit tests for different cases.</h4>
        <h2 style="text-align: center">Small project:<h2/>
        <h4>Your task is to build a small application for bookkeeping (library) including books and users.
         ...
         You are free to use any storage like files, DB, or memory.
          ...
          the focus is on the architecture.</h4>       
    '
